  ...
  return (
    <>
      ...
      <div className="usercomplaints">
        <h2 className="usercomplaints__title">Последние показатели счётчиков</h2>
        {/* <div>
          <input></input>
        </div> */}
        ...
        <CounterCards handleUserClick={props.handleUserClick} allAdminsUsers={filteredUsers && filteredUsers.sort(function (a, b) {
